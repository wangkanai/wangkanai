...
## Overview
The Wangkanai solution is a comprehensive collection of .NET libraries providing various functionalities for ASP.NET Core applications. The solution contains 37 main modules/libraries, all of which have README.md files for documentation.
