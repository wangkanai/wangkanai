...
namespace Wangkanai.Detection
{
    public class DeviceNotFoundException : ArgumentException
    {
        ...
        public DeviceNotFoundException(string message, string invalidDeviceName, Exception innerException) : base(
            message, innerException)
        {
            _invalidDeviceName = invalidDeviceName;
        }

        public DeviceNotFoundException(string paramName, string invalidDeviceName, string message) : base(message,
            paramName)
        {
            _invalidDeviceName = invalidDeviceName;
        }
