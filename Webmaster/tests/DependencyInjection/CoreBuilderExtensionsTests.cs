...
public class CoreBuilderExtensionsTests
{
   ...
   [Fact]
   public void AddWebmaster_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddWebmaster());

   [Fact]
   public void AddWebmasterBuilder_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddWebmasterBuilder());
}