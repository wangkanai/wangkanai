...
/// <summary>Provides a common awaitable structure that <see cref="ObjectMethodExecutor.ExecuteAsync"/> can return, regardless of whether the underlying value is a System.Task, an FSharpAsync, or an application-defined custom awaitable.</summary>
internal readonly struct ObjectMethodExecutorAwaitable
{
   ...
   public Awaiter GetAwaiter()
   {
      ...
      return new(customAwaiter, _isCompletedMethod, _getResultMethod, _onCompletedMethod, _unsafeOnCompletedMethod);
   }
