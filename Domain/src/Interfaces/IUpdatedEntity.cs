...
public interface IUpdatedEntity
{
   ...
   /// <remarks>This property allows tracking when an entity was last modified. It is useful for auditing purposes, providing visibility into the update history of the implementing entity.</remarks>
