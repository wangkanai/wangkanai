...
{
	/// <summary>Gets an <see cref="IQueryable"/> collection of <see cref="AuditTrail{TKey, TUserType, TUserKey}"/>. This property provides access to query audit trail records stored in the underlying data store. </summary>
	/// <typeparam name="TKey">The type of the primary key for the <see cref="AuditTrail"/> entity.</typeparam>
