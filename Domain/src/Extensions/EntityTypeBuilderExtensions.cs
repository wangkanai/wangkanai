...
{
   /// <summary>Configures the entity type to generate a new Guid value for the Id property when a new entity is added to the database context. This method is specifically designed to work with entities that implement the
   /// <see cref="IEntity{T}"/> interface with a Guid type parameter.</summary>
   ...
   /// <summary>Configures the entity type to generate a new key value for the Id property when a new entity is added to the database context. This method is specifically designed to work with entities that implement the
   /// <see cref="IEntity{T}"/> interface with an integer type parameter.</summary>
   ...
   /// <summary>Configures the entity type to generate a new value for the Id property when a new entity is added to the database context. This method is designed to work with entities that implement the
   /// <see cref="IEntity{T}"/> interface, allowing for any comparable and equatable type as the key.</summary>
