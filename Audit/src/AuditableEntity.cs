...
public abstract class AuditableEntity<T> : Entity<T>, IAuditable where T : IComparable<T>, IEquatable<T>
{
   ...
   /// <remarks>This property is nullable to account for scenarios where the creation timestamp might not be immediately available or applicable. It is primarily used to track when the entity was first instantiated or persisted into the system.</remarks>
   public DateTime? Created { get; set; }

   /// <summary>Gets or sets the date and time when the entity was last updated.</summary>
   /// <remarks>This property is nullable to accommodate scenarios where the last updated timestamp may not be available or applicable. It is typically used to track modifications made to the entity after its initial creation.</remarks>
