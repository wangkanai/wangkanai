...
/// <summary>Represents an abstract base class for auditable entities that captures user-related information during create and update operations. This class extends the
/// <see cref="AuditableEntity{T}"/> class and adheres to the <see cref="IUserAuditable"/> interface.</summary>
