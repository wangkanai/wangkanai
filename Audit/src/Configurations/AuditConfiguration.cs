...
/// <summary>Provides the configuration for the <see cref="Audit{TKey, TUserType, TUserKey}"/> entity type. This class is responsible for defining the model and entity relationship mappings for use with Entity Framework.</summary>
