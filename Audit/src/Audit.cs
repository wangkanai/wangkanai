   ...
   where TUserKey : IEquatable<TUserKey>, IComparable<TUserKey>
{
   ...
   /// <remarks>The User property represents the user who performed the action being tracked in the audit trail. It is of a generic type derived from
   /// <see cref="IdentityUser{TKey}"/> to allow flexibility in user representation.</remarks>
   public TUserType? User { get; set; }

   /// <summary>Gets or sets the timestamp for the audit trail entry.</summary>
   /// <remarks>The <c>Timestamp</c> property represents the date and time when the audit action occurred. It is used for tracking the moment an entity change was recorded in the system.</remarks>
   public DateTime Timestamp { get; set; }

   /// <summary>Gets or sets the primary key value of the audited entity.</summary>
   /// <remarks>The <see cref="PrimaryKey"/> property holds the unique identifier of the entity being audited. This value helps in identifying the specific entity record subject to the audit trail entry.</remarks>
   public string? PrimaryKey { get; set; }

   /// <summary>Gets or sets the name of the entity associated with the audit trail.</summary>
   /// <remarks>The <see cref="EntityName"/> property identifies the entity affected by the audit action. This property is typically used to associate the audit record with a specific entity type in the system, such as a database table or domain object.</remarks>
