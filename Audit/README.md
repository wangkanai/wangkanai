## Audit: Transaction audit trail simplified Domain-Driven Design for .NET
...
Welcome to `Audit`, a powerful library designed to simplify transaction auditing in your .NET applications.
