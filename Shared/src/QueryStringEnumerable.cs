...
public readonly struct QueryStringEnumerable
{
	...
	{
		private static readonly SpanAction<char, nint> s_replacePlusWithSpace = ReplacePlusWithSpaceCore;
		...
		public static unsafe string ReplacePlusWithSpace(ReadOnlySpan<char> span)
		{
			...
			{
				return string.Create(span.Length, (nint)ptr, s_replacePlusWithSpace);
			}
		}

		private static unsafe void ReplacePlusWithSpaceCore(Span<char> buffer, nint state)
		{
