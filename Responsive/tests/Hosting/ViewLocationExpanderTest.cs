...
public class ResponsiveViewLocationExpanderTest
{
   ...
   public void ExpandViewLocations_ViewLocationExpanderContext_IEnumerable_ReturnsExpected(ResponsiveViewLocationFormat format, Device deviceType, IEnumerable<string> viewLocations,
   ...
   public void PopulateValues_ViewLocationExpanderContext_Success()
   {
      ...
      Assert.NotEmpty(context.Values);
   ...
   private ViewLocationExpanderContext SetupViewLocationExpanderContext(Device deviceType)
   {
      ...
      var context = new ViewLocationExpanderContext(action, "ResponsiveWeb", "Controller", "Area", "Wangkanai.Responsive.WebmasterPage", true)
                    {
