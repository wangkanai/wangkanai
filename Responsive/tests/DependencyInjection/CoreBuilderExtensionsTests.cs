...
{
   [Fact]
   public void AddResponsive_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddResponsive());

   [Fact]
   public void AddResponsiveBuilder_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddResponsiveBuilder());
