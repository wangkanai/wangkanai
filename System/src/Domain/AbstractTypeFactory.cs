...
/// <summary>The AbstractTypeFactory class provides a way to register and create instances of derived types of a base type.</summary>
...
public static class AbstractTypeFactory<TBaseType>
{
   ...
   /// <summary>The AllTypeInfos property provides access to all registered generic type information for a specified base type.</summary>
   ...
   /// <summary>The HasOverrides property indicates whether there are any overridden types registered for the base type.</summary>
   ...
   /// <summary>Register a derived type of the base type to be created and used by the AbstractTypeFactory.</summary>
   ...
   /// <summary>Override already registered  type to new</summary>
   ...
   /// <summary>Create BaseType instance considering type mapping information</summary>
   public static TBaseType TryCreateInstance()
      => TryCreateInstance(typeof(TBaseType).Name);

   /// <summary>Create derived from BaseType  specified type instance considering type mapping information</summary>
   ...
   public static TBaseType TryCreateInstance(string typeName)
   {
      ...
      else
      {
         ...
         {
            throw new
               OperationCanceledException($"A type with {typeName} name is not registered in the AbstractFactory, you cannot create an instance of an abstract class {baseType.Name} because it does not have a complete implementation");
         }
   ...
   /// <summary>Finds the GenericTypeInfo object for a given type name.</summary>
