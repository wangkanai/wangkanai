...
{
   public ICollection<object> Services
   {
      get;
   } = new List<object>();
   ...
   /// <summary>Sets the type name for the generic type.</summary>
   ...
   /// <summary>Returns the service of type T from the collection of services.</summary>
   ...
   /// <summary>Retrieves all subclasses of the generic type.</summary>
   /// <typeparam name="TBaseType">The base type of the generic type.</typeparam>
   ...
   /// <summary>Determines whether the current GenericTypeInfo is assignable to a given type name.</summary>
   ...
   /// <summary>Adds a service to the GenericTypeInfo instance.</summary>
   ...
   /// <summary>Maps the generic type to a specified type.</summary>
   ...
   /// <summary>Sets a factory method for creating an instance of the generic type.</summary>
   ...
   /// <summary>Sets the setup action for the generic type.</summary>
