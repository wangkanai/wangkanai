...
/// <summary>Provides extension methods for the <see cref="Span{T}"/> class.</summary>
[DebuggerStepThrough]
public static class SpanExtensions
{
   /// <summary>Determines if a <see cref="Span{T}"/> is null.</summary>
   ...
   /// <summary>Determines if a <see cref="Span{T}"/> is empty.</summary>
   /// <typeparam name="T">The type of the elements in the span.</typeparam>
   /// <param name="span">The span to check.</param>
   ...
   /// <summary>Determines if a <see cref="Span{T}"/> is null or empty.</summary>
   /// <typeparam name="T">The type of the elements in the span.</typeparam>
   /// <param name="span">The span to check.</param>
