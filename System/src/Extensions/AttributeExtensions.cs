...
/// <summary>Provides extension methods for working with attributes.</summary>
[DebuggerStepThrough]
public static class AttributeExtensions
{
   /// <summary>Splits the given string into an array of strings based on a specified separator.</summary>
