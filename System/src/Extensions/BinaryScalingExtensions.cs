...
/// <summary>Provides extension methods for scaling binary values to human-readable formats.</summary>
[DebuggerStepThrough]
public static class BinaryScalingExtensions
{
   private static readonly string[] Sizes = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"];

   /// <summary>Converts a binary value to human-readable format.</summary>
