...
{
	/// <summary>
	/// Converts the specified enumeration value to its original string representation.
	/// </summary>
	...
	/// <summary>
	/// Converts the specified enumeration value to its lowercased string representation.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	/// <param name="value">The enumeration value to convert.</param>
	...
	/// <summary>
	/// Converts the specified enumeration value to its uppercased string representation.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	/// <param name="value">The enumeration value to convert.</param>
	...
	/// <summary>
	/// Determines whether the specified string contains the original string representation of the specified enumeration value.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	...
	/// <summary>
	/// Determines whether the specified string value contains an uppercase representation of the specified flags.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	...
	/// <summary>
	/// Determines whether the specified string contains the lowercased string representation of the given enumeration value.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	/// <param name="value">The string value to search within.</param>
	/// <param name="flags">The enumeration value to search for.</param>
	...
	/// <summary>
	/// Retrieves the individual flags of an enumeration value.
	/// </summary>
	/// <typeparam name="T">The type of the enumeration.</typeparam>
	...
	/// <summary>
	/// Gets the custom value of the specified enumeration member, if available.
	/// </summary>
