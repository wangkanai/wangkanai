...
/// <summary>Provides extension methods for the System.Type class.</summary>
[DebuggerStepThrough]
public static class TypeExtensions
{
   ...
   /// <summary>Get the cache key for a given type.</summary>
   ...
   /// <summary>Pretty-print the given Type.</summary>
   ...
   /// <summary>Recursively pretty-prints the given Type.</summary>
   /// <param name="type">The Type to be pretty-printed.</param>
   ...
   /// <summary>Returns an array of types representing the inheritance chain from a given child type to a specified parent type.</summary>
   ...
   /// <summary>Check if type is a value-type, primitive type or string</summary>
   /// <param name="type"></param>
   /// <returns></returns>
   private static bool IsPrimitive(this Type type)
      => type == typeof(string) || type.IsValueType || type.IsPrimitive;

   /// <summary>Check if type is a value-type, primitype or string</summary>
   /// <param name="obj"></param>
   /// <returns></returns>
   public static bool IsPrimitive(this object? obj)
      => obj == null || obj.GetType().IsPrimitive();

   /// <summary>Determines whether a given type is nullable.</summary>
   ...
   /// <summary>Makes a given type nullable or non-nullable based on the specified flag.</summary>
   ...
   /// <summary>Unwraps a nullable type, returning the underlying non-nullable type. If the given type is not nullable, it returns the same type.</summary>
   /// <param name="type">The nullable type to unwrap.</param>
   /// <returns>The underlying non-nullable type.</returns>
   public static Type UnwrapNullable(this Type type)
      => Nullable.GetUnderlyingType(type) ?? type;

   /// <summary>Unwraps an enum type, returning the underlying non-enum type. If the given type is not an enum, it returns the same type.</summary>
   ...
   /// <summary>Traverse the object graph of the given object recursively and return a collection of key-value pairs representing the members of the object and their corresponding values.</summary>
   ...
   {
      yield return new(memberPath, original!);
