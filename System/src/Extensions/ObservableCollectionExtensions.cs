...
/// <summary>Contains extension methods for ObservableCollection class.</summary>
[DebuggerStepThrough]
public static class ObservableCollectionExtensions
{
   /// <summary>Adds event handlers to the <see cref="ObservableCollection{T}.CollectionChanged"/> event to observe changes in the collection.</summary>
