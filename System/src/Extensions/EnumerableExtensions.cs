...
/// <summary>Provides extension methods for enumerable.</summary>
[DebuggerStepThrough]
public static class EnumerableExtensions
{
   /// <summary>Determines whether the given enumerable is null.</summary>
   ...
   /// <summary>Determines whether the given enumerable is empty.</summary>
   /// <typeparam name="T">The type of the enumerable.</typeparam>
   /// <param name="list">The enumerable to check.</param>
   ...
   /// <summary>Determines whether the given enumerable is null or empty.</summary>
   /// <typeparam name="T">The type of the enumerable.</typeparam>
   /// <param name="list">The enumerable to check.</param>
   ...
   /// <summary>Determines whether the given enumerable has any duplicates based on a specified property selector.</summary>
   ...
   /// <summary>Splits an enumerable into smaller chunks (pages) based on a specified page size.</summary>
   /// <typeparam name="T">The type of the elements in the enumerable.</typeparam>
   ...
   /// <summary>Performs the indicated action on each item.</summary>
   ...
   /// <summary>Converts an enumerable to a dictionary using the provided selector function to map the values to keys.</summary>
   ...
   /// <summary>Converts an enumerable of values to an <see cref="IDictionary{TKey, TValue}"/> using the specified key selector and default equality comparer for the key type.</summary>
   ...
   /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <see langword="null"/> to use the default
   /// <see cref="EqualityComparer{T}"/> for the type of the key.</param>
