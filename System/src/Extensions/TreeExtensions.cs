...
/// <summary>
/// Provides extension methods for tree operations on a generic type.
/// </summary>
[DebuggerStepThrough]
public static class TreeExtensions
{
	/// <summary>
	/// Traverses a tree structure starting from a specified node and retrieves all nodes in a depth-first manner.
	/// </summary>
	...
	/// <summary>
	/// Retrieves all ancestors of the specified item in a tree structure.
	/// </summary>
	/// <typeparam name="T">The type of the tree node.</typeparam>
