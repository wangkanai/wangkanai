...
/// <summary>Provides utility methods for working with enum values.</summary>
/// <typeparam name="T">The type of the enum.</typeparam>
/// <remarks>This class is designed to work with enums that have the [Flags] attribute.</remarks>
[DebuggerStepThrough]
public static class EnumValues<T> where T : Enum
{
   ...
   /// <summary>Retrieves an array of all values of the specified enum type.</summary>
   /// <typeparam name="T">The type of the enum.</typeparam>
   /// <returns>An array of all values of the specified enum type.</returns>
   public static T[] GetValues()
      => Values;

   /// <summary>Retrieves the individual flags that are set for the specified enum value.</summary>
   ...
   /// <summary>Retrieves all names corresponding to the values of the specified enum type.</summary>
   /// <typeparam name="T">The type of the enum.</typeparam>
   ...
   /// <summary>Tries to retrieve the single name of the specified enumeration value.</summary>
   ...
   /// <returns><see langword="true"/> if the single name of the specified enumeration value is successfully retrieved; otherwise
   ...
   /// <summary>Retrieves the original name(s) of the specified enum value.</summary>
   /// <typeparam name="T">The type of the enum.</typeparam>
   ...
   /// <summary>Retrieves the lowercased name of the specified enum value.</summary>
   /// <typeparam name="T">The type of the enum.</typeparam>
   ...
   /// <summary>Retrieves the uppercased name of the specified enum value.</summary>
   /// <typeparam name="T">The type of the enum.</typeparam>
   /// <param name="value">The enum value.</param>
   ...
   /// <summary>Returns corresponding enum value based on its string representation</summary>
