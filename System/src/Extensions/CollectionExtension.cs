...
public static class CollectionExtension
{
	...
	/// <exception cref="ArgumentNullException">An <see cref="ArgumentNullException"/> is thrown if <paramref name="list"/> or <paramref name="items"/> is <see langword="null"/>.</exception>
	...
	/// <summary>
	/// Adds distinct items to the collection.
	/// </summary>
	/// <typeparam name="T">The type of objects within the collection.</typeparam>
