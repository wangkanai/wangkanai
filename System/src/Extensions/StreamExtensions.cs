...
{
   /// <summary>Copies the content of one stream to another stream.</summary>
   ...
   /// <summary>Reads the entire content of a stream and returns it as a byte array.</summary>
   ...
   /// <summary>Reads the content of a stream and returns it as a string.</summary>
   /// <param name="stream">The stream from which to read the content.</param>
