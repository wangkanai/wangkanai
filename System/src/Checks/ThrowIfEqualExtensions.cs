...
/// <summary>Contains extension methods for throwing an exception if a value is equal to the expected value.</summary>
[DebuggerStepThrough]
public static class ThrowIfEqualExtensions
{
   /// <summary>Throws an exception if the value is equal to the expected value.</summary>
