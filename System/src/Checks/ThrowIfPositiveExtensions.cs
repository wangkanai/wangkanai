...
/// <summary>Provides extension methods to throw an exception if a value is positive.</summary>
[DebuggerStepThrough]
public static class ThrowIfPositiveExtensions
{
   /// <summary>Throws an exception if the specified value is positive.</summary>
