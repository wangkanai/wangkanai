...
/// <summary>Static class containing extension methods for throwing ArgumentNullException if a value is null.</summary>
[DebuggerStepThrough]
public static class ThrowIfNullGenericExtensions
{
   /// <summary>Throws an ArgumentNullException if the value is null.</summary>
