...
/// <summary>
/// A static class that provides extension methods to throw exceptions if a value is zero.
/// </summary>
[DebuggerStepThrough]
public static class ThrowIfZeroExtensions
{
	/// <summary>
	/// Throws an exception of type T if the given value is zero.
	/// </summary>
	...
	/// <summary>
	/// Throws an exception of type <exception cref="ArgumentZeroException"></exception> if the given value is zero.
	/// </summary>
	/// <param name="value">The value to check.</param>
	...
	/// <summary>
	/// Throws an exception of type <see cref="ArgumentException"/> if the given value is zero.
	/// </summary>
