...
/// <summary>Provides extension methods to throw an exception if a nullable value is null.</summary>
[DebuggerStepThrough]
public static class CheckThrowIfNullExtensions
{
   /// <summary>Throws an <exception cref="ArgumentNullException">exception</exception> if the value is null.</summary>
   ...
   /// <summary>Throws an <exception cref="ArgumentException">exception</exception> if the value is null.</summary>
   /// <param name="value">The value to check for null.</param>
