...
/// <summary>Provides extension methods to throw an exception if a string is null or empty.</summary>
[DebuggerStepThrough]
public static class ThrowIfNullOrEmptyExtensions
{
   /// <summary>Throws an exception if the given string is null or empty.</summary>
