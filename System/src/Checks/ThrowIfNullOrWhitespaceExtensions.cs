...
/// <summary>
/// Extension methods for throwing exceptions if a string is null or whitespace.
/// </summary>
[DebuggerStepThrough]
public static class ThrowIfNullOrWhitespaceExtensions
{
	/// <summary>
	/// Throws an exception of type <see cref="ArgumentNullOrWhitespaceException"/> if the specified string value is null or whitespace.
	/// </summary>
