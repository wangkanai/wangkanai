...
/// <summary>Provides extension methods for throwing exceptions if a string is whitespace.</summary>
[DebuggerStepThrough]
public static class ThrowIfWhitespaceExtensions
{
   /// <summary>Throws an exception if the specified string is null, empty, or consists only of whitespace characters.</summary>
