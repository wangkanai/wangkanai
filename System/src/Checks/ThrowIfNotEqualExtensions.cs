...
/// <summary>Provides extension methods for throwing exceptions if values are not equal.</summary>
[DebuggerStepThrough]
public static class ThrowIfNotEqualExtensions
{
   /// <summary>Throws an exception if the specified value is not equal to the expected value.</summary>
