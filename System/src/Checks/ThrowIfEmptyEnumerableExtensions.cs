...
/// <summary>Provides extension methods to throw an exception if an enumerable collection is empty.</summary>
[DebuggerStepThrough]
[SuppressMessage("ReSharper", "PossibleMultipleEnumeration")]
public static class ThrowIfEmptyExtensions
{
   /// <summary>Throws an ArgumentEmptyException if the enumerable collection is empty.</summary>
