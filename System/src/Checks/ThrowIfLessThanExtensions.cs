...
/// <summary>Provides extension methods for throwing exceptions if a value is less than the expected value.</summary>
[DebuggerStepThrough]
public static class ThrowIfLessThanExtensions
{
   /// <summary>Throws an exception if the provided value is less than the expected value.</summary>
