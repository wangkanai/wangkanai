...
/// <summary>Provides extension methods for throwing an <see cref="ArgumentOutOfRangeException"/> if a value is out of range.</summary>
[DebuggerStepThrough]
public static class ThrowIfOutOfRangeExtension
{
   /// <summary>Throws an <see cref="ArgumentOutOfRangeException"/> if the specified value is out of the specified range.</summary>
