...
public static class Operator
{
	...
	{
		return Operator<T>.NullOperator.HasValue(value);
	}

	public static bool AddIfNotNull<T>(ref T accumulator, T value)
	{
		return Operator<T>.NullOperator.AddIfNotNull(ref accumulator, value);
	}
	...
	{
		return Operator<T>.Or(left, right);
	}

	public static T And<T>(T left, T right)
	{
		return Operator<T>.And(left, right);
	}

	public static T Xor<T>(T left, T right)
	{
		return Operator<T>.Xor(left, right);
	}
	...
	{
		return Operator<TArg2, TArg1>.Add(left, right);
	}
	...
	{
		return Operator<TArg2, TArg1>.Subtract(left, right);
	}
	...
	{
		return Operator<TArg2, TArg1>.Multiply(left, right);
	}
	...
	{
		return Operator<TArg2, TArg1>.Divide(left, right);
	}
