...
/// <summary>Provides a string array comparer for comparing string arrays for equality.</summary>
internal sealed class StringArrayComparer : IEqualityComparer<string[]>
{
   ...
   /// <summary>Provides a string array comparer for comparing string arrays for equality.</summary>
   public StringArrayComparer(StringComparer valueComparer) => _valueComparer = valueComparer;
   ...
   /// <summary>Calculates the hash code for a string array based on its elements using the provided comparer.</summary>
