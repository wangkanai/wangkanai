...
/// <summary>Default ProjectionEqualityComparer helper to produce instances of the generic
/// <see cref="ProjectionEqualityComparer{TSource,TKey}"/> class.</summary>
public static class ProjectionEqualityComparer
{
   /// <summary>Creates an instance of the <see cref="ProjectionEqualityComparer{TSource,TKey}"/> using the given specified projection, which must not be null.</summary>
...
/// <summary>Default generic <see cref="ProjectionEqualityComparer{TSource}"/> helper in the source only to produce instances of the double generic
/// <see cref="ProjectionEqualityComparer{TSource,TKey}"/> class. Optionally using the type inference.</summary>
...
public class ProjectionEqualityComparer<TSource, TKey> : IEqualityComparer<TSource>
{
   ...
   /// <summary>Compares x and y for equality by applying the projection to each value and then using the equality comparer on the resulting keys.</summary>
   /// <returns>Both <see cref="x"/> and <see cref="y"/> are null then return True; If only one of <see cref="x"/> and <see cref="y"/> is null then return False; Otherwise return the standard Compare value.</returns>
   ...
   /// <summary>Computes the hash code for the specified object using the default hash function.</summary>
