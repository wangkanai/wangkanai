...
public class Range<T>
{
	...
	public Range<T> ExcludeEnd()
		=> IncludesEnd
			   ? new Range<T>(Start, End, Comparer, IncludesStart, false)
			   : this;
	...
	public Range<T> ExcludeStart()
		=> IncludesStart
			   ? new Range<T>(Start, End, Comparer, false, IncludesEnd)
			   : this;
	...
	public Range<T> IncludeEnd()
		=> !IncludesEnd
			   ? new Range<T>(Start, End, Comparer, IncludesStart, true)
			   : this;
	...
	public Range<T> IncludeStart()
		=> !IncludesStart
			   ? new Range<T>(Start, End, Comparer, true, IncludesEnd)
			   : this;
