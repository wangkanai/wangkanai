...
public class ComparisonComparerTests
{
	...
	{
		Assert.Throws<ArgumentNullException>(() => new ComparisonComparer<string>(null));
	}

	[Fact]
	public void CreateComparisonWithNull()
	{
		Assert.Throws<ArgumentNullException>(() => ComparisonComparer<string>.CreateComparison(null));
	}
