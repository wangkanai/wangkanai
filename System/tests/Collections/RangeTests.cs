...
public class RangeTests
{
   ...
   public void CustomComparer()
   {
      ...
      subject = new("a", "f", StringComparer.OrdinalIgnoreCase);
      Assert.True(subject.Contains("B"));
   ...
   {
      var subject = new Range<int>(0, 5, Comparer<int>.Default, false);
   ...
   [Fact]
   public void StartGreaterThanEndThrows() => Assert.Throws<ArgumentOutOfRangeException>(() => new Range<int>(5, 0));
