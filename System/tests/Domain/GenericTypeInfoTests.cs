...
{
   private readonly GenericTypeInfo<Child>  child  = new(typeof(Child));
   private readonly GenericTypeInfo<Parent> parent = new(typeof(Parent));
   ...
   {
      var custom = parent.WithFactory(() => new());
