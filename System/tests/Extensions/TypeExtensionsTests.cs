...
public class TypeExtensionsTests
{
   ...
   [Fact]
   public void PrimitiveType() => Assert.True(typeof(int).IsPrimitive);

   [Fact]
   public void NotPrimitiveType() => Assert.False(typeof(Alone).IsPrimitive);

   [Fact]
   public void PrimitiveObject() => Assert.True(1.IsPrimitive());

   [Fact]
   public void NotPrimitiveObjectNull() => Assert.True(((object?)null).IsPrimitive());

   [Fact]
   public void NotPrimitiveObjectString() => Assert.True("".IsPrimitive());
   ...
   [Fact]
   public void UnwrapEnum() => Assert.Equal(typeof(int), typeof(TestEnum).UnwrapEnum());

   [Fact]
   public void UnwrapEnumNullable() => Assert.Equal(typeof(int?), typeof(TestEnum?).UnwrapEnum());
