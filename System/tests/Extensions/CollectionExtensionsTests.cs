...
{
   private readonly EqualityComparer<int> _comparerInt = EqualityComparer<int>.Default;

   private readonly EqualityComparer<string> _comparerString = EqualityComparer<string>.Default;
   private readonly List<int>?               _emptyInts      = [];
   private readonly List<string>?            _emptyStrings   = [];
   private readonly List<int>?               _existInts      = [int.MinValue, int.MinValue];
