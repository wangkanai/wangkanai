...
public class CheckTests
{
    ...
    [Fact]
    public void NativeIntegralIfNullThrow()
    {
        nint?  _nint  = null;
        nuint? _nuint = null;
    ...
    [Fact]
    public void FloatingIfNullThrowNullException()
    {
        float?   _float   = null;
        double?  _double  = null;
    ...
    [Fact]
    public void FloatingIfNullThrowCustomException()
    {
        float?   _float   = null;
        double?  _double  = null;
        decimal? _decimal = null;
    ...
    [Fact]
    public void TrueIfNullReturnTrue()
    {
        byte?    _byte    = null;
        short?   _short   = null;
        int?     _int     = null;
