...
public class OperatorTests
{
   ...
   {
      var from = 300;
      var d    = Operator.Convert<int, double>(from);
      var i    = Operator.Convert<double, int>(d);
      Assert.Equal(i, from);
      Assert.Equal(d, i);
   }
   ...
   public void Zero()
   {
      Assert.Equal(0, Operator<int>.Zero);
      Assert.Equal(0, Operator<float>.Zero);
   ...
   [Fact]
   public void AddInt32() => Assert.Equal(43 + 230, Operator.Add(43, 230));

   [Fact]
   public void AddDateTimeTimeSpan()
   {
      var from  = DateTime.Today;
      var delta = TimeSpan.FromHours(73.5);
   ...
   [Fact]
   public void SubtractInt32() => Assert.Equal(270 - 54, Operator.Subtract(270, 54));
   ...
   [Fact]
   public void MultiplyInt32() => Assert.Equal(270 * 54, Operator.Multiply(270, 54));

   [Fact]
   public void MultiplyString() =>
      Assert.Throws<InvalidOperationException>(() => Operator.Multiply("abc", "def")
                                              );
   ...
   public void MultiplyFloatInt32()
   {
      ...
      Assert.Throws<InvalidOperationException>(() => Operator.MultiplyAlternative(from, factor)
                                              );
   }

   [Fact]
   public void DivideInt32() => Assert.Equal(270 / 54, Operator.Divide(270, 54));

   [Fact]
   public void DivideDouble() => Assert.Equal(14514.7 / 45.2, Operator.Divide(14514.7, 45.2));

   [Fact]
   public void DivideInt32DoubleTest() => Assert.Equal(14514 / 45, Operator.DivideInt32(14514, 45));
   ...
   public void DivideFloatInt32()
   {
      ...
      Assert.Throws<InvalidOperationException>(() => Operator.DivideInt32(from, divisor)
                                              );
      Assert.Throws<InvalidOperationException>(() => Operator.DivideAlternative(from, divisor)
                                              );
   }
   ...
   [Fact]
   public void NegateInt32() => Assert.Equal(-270, Operator.Negate(270));


   [Fact]
   public void NegateString() =>
      Assert.Throws<InvalidOperationException>(() => Operator.Negate("abc")
                                              );

   [Fact]
   public void NotInt32() => Assert.Equal(~270, Operator.Not(270));

   [Fact]
   public void OrInt32() => Assert.Equal(270 | 54, Operator.Or(270, 54));

   [Fact]
   public void AndInt32() => Assert.Equal(230 & 43, Operator.And(230, 43));

   [Fact]
   public void XorInt32() => Assert.Equal(270 ^ 54, Operator.Xor(270, 54));
