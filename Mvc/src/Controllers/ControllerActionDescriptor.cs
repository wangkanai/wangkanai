...
/// <summary>A descriptor for an action of a controller.</summary>
...
public class ControllerActionDescriptor : ActionDescriptor
{
   ...
   /// <summary>The <see cref="MethodInfo"/>.</summary>
   public MethodInfo MethodInfo { get; set; } = default!;

   /// <summary>The <see cref="TypeInfo"/> of the controller..</summary>
      ...
      get
      {
         if (base.DisplayName == null && ControllerTypeInfo != null && MethodInfo != null)
         {
            base.DisplayName = string.Format(
                                             ...
                                             "{0}.{1} ({2})",
                                             ControllerTypeInfo.GetTypeDisplayName(),
                                             MethodInfo.Name,
