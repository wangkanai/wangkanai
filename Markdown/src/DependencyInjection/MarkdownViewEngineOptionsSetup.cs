...
internal sealed class MarkdownViewEngineOptionsSetup : IConfigureOptions<MarkdownViewEngineOptions>
{
   ...
   public MarkdownViewEngineOptionsSetup(IOptions<MarkdownPagesOptions> pagesOptions) => _pagesOptions = pagesOptions?.Value ?? throw new ArgumentNullException(nameof(pagesOptions));
