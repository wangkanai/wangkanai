...
public sealed class ConfigOption
{
    ...
    /// <summary>
    ///     Specifies what percentage of users should be tracked. This defaults to 100 (no users are sampled out) but large
    ///     sites may need to use a lower sample rate to stay within Google Wangkanai.Universal processing limits.
    /// </summary>
    public int? SampleRate { get; set; }

    /// <summary>
    ///     This setting determines how often site speed tracking beacons will be sent. By default, 1% of visitors will be
    ///     automatically be tracked.
    /// </summary>
    public int? SiteSpeedSampleRate { get; set; }

    /// <summary>
    ///     By default the HTTP referrer URL, which is used to attribute traffic sources, is only sent when the hostname of the
    ///     referring site differs from the hostname of the current page. Enable this setting only if you want to process other
    ///     pages from your current host as referrals.
    /// </summary>
    ...
    /// <summary>
    ///     Specifies the domain used to store the analytics cookie. Setting this to 'none' sets the cookie without specifying
    ///     a domain.
    /// </summary>
    ...
    /// <summary>
    ///     This field is used to configure how analytics.js searches for cookies generated by earlier Google
    ///     Wangkanai.Universal tracking scripts such as ga.js and urchin.js.
    /// </summary>
