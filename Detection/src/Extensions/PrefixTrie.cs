...
public readonly struct PrefixTrie : IPrefixTrie
{
   ...
   /// <summary>Creates optimized search Trie using static keyword list, uses prefix search Trie as base algorithm
   /// <see href="https://en.wikipedia.org/wiki/Trie"/></summary>
