...
public sealed class BrowserServiceTests
{
   ...
   public void Null()
   {
      var resolver = MockService.BrowserService(null!);
      Assert.NotNull(resolver);
      Assert.Equal(Browser.Unknown, resolver.Name);
      Assert.Equal(new(0, 0),       resolver.Version);
   }
   ...
   [InlineData("40.15254.369",
               "Mozilla/5.0 (Windows Mobile 10; Android 8.0.0; Microsoft; Lumia 950XL) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.116 Mobile Safari/537.36 Edge/40.15254.369")]
