...
public class CrawlerServiceTests
{
   ...
   public void Google()
   {
      ...
      Assert.Equal(new(2, 1),      crawler.Version);
   }
   ...
   public void Facebook()
   {
      ...
      Assert.Equal(new(1, 1),        crawler.Version);
   }
   ...
   public void BingBot()
   {
      ...
      Assert.Equal(new(2, 0),    resolver.Version);
   }
   ...
   public void Twitter()
   {
      ...
      Assert.Equal(new(1, 0),       resolver.Version);
   }
   ...
   public void Yahoo()
   {
      ...
      Assert.Equal(new(),         resolver.Version);
   }
   ...
   public void WhatsApp()
   {
      ...
      Assert.Equal(new(2, 18, 61),   resolver.Version);
   }
