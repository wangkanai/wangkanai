...
public class PlatformServiceTests
{
   ...
   public PlatformServiceTests(ITestOutputHelper testOutputHelper) => _testOutputHelper = testOutputHelper;
   ...
   [InlineData("14.7.1",
               "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) WebKit/8611 (KHTML, like Gecko) Mobile/18G82 [FBAN/FBIOS;FBDV/iPhone12,3;FBMD/iPhone;FBSN/iOS;FBSV/14.7.1;FBSS/3;FBID/phone;FBLC/en_GB;FBOP/5]")]
