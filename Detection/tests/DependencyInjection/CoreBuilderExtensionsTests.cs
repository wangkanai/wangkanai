...
{
   [Fact]
   public void AddDetection_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddDetection());

   [Fact]
   public void AddDetectionBuilder_Null_ArgumentNullException() => Assert.Throws<ArgumentNullException>(() => ((IServiceCollection)null!).AddDetectionBuilder());
