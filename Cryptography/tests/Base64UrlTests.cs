...
{
   [Fact]
   public void Encode_Null() => Assert.Throws<ArgumentNullException>(() => Base64Url.Encode(null!));

   [Fact]
   public void Decode_Null() => Assert.Throws<ArgumentNullException>(() => Base64Url.Decode(null!));
