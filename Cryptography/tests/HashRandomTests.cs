...
public class HashRandomTests
{
   ...
   [Fact]
   public void CreateRandomKey_Length0() => Assert.Throws<ArgumentLessThanException>(() => HashRandom.CreateRandomKey(0));

   [Fact]
   public void CreateRandomKey_LengthMinus() => Assert.Throws<ArgumentLessThanException>(() => HashRandom.CreateRandomKey(-1));
   ...
   {
      var hash = HashRandom.CreateUniqueId(16);
      Assert.NotNull(hash);
      Assert.NotEmpty(hash);
   ...
   [Fact]
   public void CreateUniqueId_Length0() => Assert.Throws<ArgumentLessThanException>(() => HashRandom.CreateUniqueId(0));

   [Fact]
   public void CreateUniqueId_LengthMinus() => Assert.Throws<ArgumentLessThanException>(() => HashRandom.CreateUniqueId(-1));

   [Fact]
   public void CreateUniqueId_Length16_FormatInvalid() => Assert.Throws<ArgumentOutOfRangeException>(() => HashRandom.CreateUniqueId(16, (HashRandom.OutputFormat)99));
